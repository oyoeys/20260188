...
def main():
    ...
    while True:
        ...
        display_score = int(score) # 화면과 로직에 사용할 정수 점수
        ...
        # 1. 상단 스폰 (적 생성 시 해당 적의 점수 가치를 함께 저장)
        v_spawn_timer += 1
        ...
        if v_spawn_timer >= target_v_spawn:
            ...
            enemies.append({
                ...
                "score_value": 1.0 / width_ratio # 가로가 넓어져 스폰이 많아지면 점수 가치는 하락
            })
        ...
        for enemy in enemies:
            ...
            if not is_out_of_bounds:
                ...
                score += enemy["score_value"] # 밖으로 나간 적의 계산된 가치만큼만 점수 증가
